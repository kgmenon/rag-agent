...
output "litellm_endpoint" {
  description = "LiteLLM proxy endpoint (internal)"
  value       = "http://litellm.${var.project_name}.local:4000"
}

output "litellm_config_bucket" {
  description = "Name of the LiteLLM config S3 bucket"
